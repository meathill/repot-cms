...
export interface ApiChainChain extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    developer_docs: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    network_layer: Schema.Attribute.String;
    network_type: Schema.Attribute.String;
    ...
    whitepaper: Schema.Attribute.String;
  };
}

export interface ApiContractStarLogContractStarLog
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contract-star-log.contract-star-log'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiContractContract extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    star_logs: Schema.Attribute.Relation<
      ...
      'api::contract-star-log.contract-star-log'
    >;
    stars: Schema.Attribute.Relation<
      'oneToOne',
      'api::contract-star.contract-star'
    >;
...
export interface ApiProtocolStarProtocolStar
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    protocol: Schema.Attribute.Relation<'oneToOne', 'api::protocol.protocol'>;
    publishedAt: Schema.Attribute.DateTime;
    stars: Schema.Attribute.BigInteger;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
